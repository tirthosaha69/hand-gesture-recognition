...
dataset_dir = os.path.join(project_root, "dataset","Raw","participant_1")
output_dir = os.path.join(project_root, "dataset","Normalized","participant_1")
...
if __name__ == "__main__":
    for gesture_dir in os.listdir(dataset_dir):
        ...
        print(f"Completed gesture: {gesture_dir}")
